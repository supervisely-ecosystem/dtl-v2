...
class DuplicateObjectsAction(AnnotationAction):
    ...
    def create_new_layer(cls, layer_id: Optional[str] = None):
        ...
        classes_mapping_widget_field = Field(
            ...
            title="Classes",
            description="Select classes for which you want to duplicate objects",
        )
        ...
        def meta_changed_cb(project_meta: ProjectMeta):
            ...
            old_obj_classes = [cls for cls in project_meta.obj_classes]
