...
class FilterVideoWithoutObjects(FilterAndConditionAction):
    ...
    def create_new_layer(cls, layer_id: Optional[str] = None):
        ...
        exclude_classes_list_field = Field(
            title="Select which classes should not be presented on the video",
            description=(
                "Videos without objects of the selected classes will be filtered out to the output branch 'True', "
