...
def create_job_description_widgets():
    # SIDEBAR SETTINGS
    lj_description_title_input = Input(value="Labeling Job", placeholder="Labeling Job")
    ...
    # LAYOUT
    lj_description_edit_text = Text("Job Info", status="text", font_size=get_text_font_size())
