...
def model_settings_from_yaml(_model_settings: dict) -> dict:
    model_settings = {}
...
def update_model_inference_settings(session_id: int, model_settings: dict) -> None:
    session = Session(g.api, session_id)
    model_settings = model_settings_from_yaml(model_settings)
...
### CLASSES AND TAGS
def set_model_classes(obj_classes: List[ObjClass]):
...
def set_model_tags(tag_metas: List[TagMeta]):
...
def set_deployed_model_from_json(settings: dict) -> int:
...
def set_model_info_from_json(settings: dict) -> None:
    session_id = settings.get("session_id", None)
...
def set_model_suffix_from_json(settings: dict) -> None:
    model_suffix = settings.get("model_suffix", "model")
    model_suffix_input.set_value(model_suffix)


def set_use_model_suffix_from_json(settings: dict) -> None:
...
def set_model_apply_method_from_json(settings: dict) -> None:
...
def set_model_settings_preview() -> None:
...
def set_default_model_settings(session_id: int) -> None:
