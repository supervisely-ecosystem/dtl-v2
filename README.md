...
| **Other Augmentations**                                                                                                                                                                                           |                                                             |        |        |
| [Pixelate](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/other_augs/pixelate/README.md#pixelate)                                                                                     | Pixelate the data.                                                  | +      | -      |
| [Elastic Transform](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/other_augs/elastic_transform/README.md#elastic-transform)                                                                                     | Apply Elastic Transform to data.                       | +      | -      |
