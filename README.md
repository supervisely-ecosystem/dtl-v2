...
| [Deploy YOLOv8](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/neural_networks/deploy/yolov8.md)                                                                                        | Deploy pretrained or custom YOLOv8 model.                   | +      | -      |
...
| [Deploy MMSegmentation](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/neural_networks/deploy/mmsegmentation.md)                                                                        | Deploy pretrained or custom MMDetection model.              | +      | -      |
| **Other**                                                                                                                                                                                                                   |                                                             |        |        |
