...
| [ImgAug Studio](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl/actions/imgaug_augs/studio/README.md)                                                                                            | ImgAug Studio is a wrapper around great [ImgAug Library](https://github.com/aleju/imgaug). | +      | -      |
...
| [Objects Filter by Area](https://github.com/supervisely-ecosystem/data-nodes/blob/master/src/ui/dtl//actions/annotation_transforms/objects_filter_by_area/README.md#objects-filter-by-area)                                 | Tag or remove filtered objects by area.                                                    | +      | -      |
